...
public class TimedTransitionPropertyComposite extends TransitionPropertyComposite {
	...
	public TimedTransitionPropertyComposite(Element net, Composite parent) {
		super(net, parent);
		columnNames = new String[] { "Name", "Real Color", "Mean Firing Delay" };
		initProperties();
		initColorTable();
	}
		...
		delModeButton.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				if (connectionsUsingCurrentMode.size() > 0) {
					MessageBox messageBox = new MessageBox(TimedTransitionPropertyComposite.this.getShell(), SWT.ICON_WARNING | SWT.YES | SWT.NO);
					messageBox
		...
		modeTableViewer.setLabelProvider(new ITableLabelColorProvider() {
			...
			public String getColumnText(Object element, int columnIndex) {
				...
				case 1:
					return "";
				case 2:
					return mode.attributeValue("mean-firing-delay", "1.0");
				}
				return null;
			}
		...
		modeTableViewer.setCellModifier(new ICellModifier() {
			...
			public Object getValue(Object element, String property) {
				...
				case 1:
					return null;
				case 2:
					return Double.parseDouble(mode.attributeValue("mean-firing-delay", "1"));
				}
			...
			public void modify(Object element, String property, Object value) {
				...
				case 2:
					...
					if(dValue >= 0) {
						DocumentManager.setAttribute(mode, "mean-firing-delay", ((Double) value).toString());
					}
				}
