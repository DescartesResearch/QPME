<<<<<<< HEAD:sources/qpme-parent/qpme.simqpn.kernel/src/de/tud/cs/simqpn/kernel/StatsDocumentBuilder.java
/* ==============================================
...
public class StatsDocumentBuilder {
	...
	public StatsDocumentBuilder(Stats[] data, Element net, String configuration) {
		this.data = data;
		this.net = net;
...
>>>>>>> d2a84ea... Restructure Source Tree:sources/qpme.simqpn.kernel/src/de/tud/cs/simqpn/kernel/StatsDocumentBuilder.java
