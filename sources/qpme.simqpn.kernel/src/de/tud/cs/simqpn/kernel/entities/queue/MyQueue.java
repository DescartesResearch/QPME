...
public abstract class MyQueue {
	...
	private static Logger log = Logger.getLogger(MyQueue.class);
	 ...
	 */
//	public MyQueue(MyQueue queue, SimQPNConfiguration configuration, Place[] places)
//			throws SimQPNException {
//		this.id = queue.id;
...
//	}
	 ...
	 */
//	public MyQueue(int id, String xmlId, String name, int queueDiscip,
