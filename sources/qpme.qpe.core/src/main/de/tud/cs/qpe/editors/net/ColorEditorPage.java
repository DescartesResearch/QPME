...
public class ColorEditorPage extends EditorPart implements PropertyChangeListener {
	...
	public void createPartControl(Composite parent) {
		...
		initTable(parent);
		// Add buttons for adding and deleting colors
