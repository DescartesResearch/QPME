...
public class RT1 extends SimulationTest {
	...
	public static void init() throws Exception {
		initTest("RT1", "ispass03.qpe", "example_config");
	}
	...
	public void checkR100() throws Exception {		
		...
		r100ref.load(new File("testfiles/RT1/reference/r100/reference-testdata.xml"));
	...
	public void checkR162() throws Exception {		
		...
		r162ref.load(new File("testfiles/RT1/reference/r162/reference-testdata.xml"));
